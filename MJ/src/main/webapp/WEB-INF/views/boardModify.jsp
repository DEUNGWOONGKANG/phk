...
function goback(){
  ...
  <body>
    <!-- navbar-->
      	<form id="formdata" action="/boardUpdate" method="post" style="width:100%">
      	...
      	<input type="hidden" id="id" name="id" value="${board.id }">
			  ...
			  <tbody>
			    <tr>
			      <th style="">제목</th>
				  <td>
				  	<input type="text" placeholder="제목" id="title" name="title" style="width:70%" value="${board.title}">
				  </td>
			    </tr>
			    <tr style="height:100px">
			      <th>내용</th>
				  <td><textarea id="content" name="content" style="width:98%;height:95%">${board.content}</textarea></td>
			    </tr>
			  </tbody>
			</table>
			<div class="btndiv">
